...
pub fn conv1d_simd(
    ...
    let _in_channels = input.shape[1];
        ...
        if std::is_x86_feature_detected!("avx2") && std::is_x86_feature_detected!("fma") {
            unsafe {
                return conv1d_avx2_fma(
                    ...
                    out_channels, kernel_size, out_length,
                    stride, padding
                );
            }
        }
...
unsafe fn conv1d_avx2_fma(
    ...
    let out_ptr = output.data.as_mut_ptr();
                ...
                for ic in 0..in_channels {
                    ...
                    for k in 0..kernel_size {
                        ...
                        for lane in 0..8 {
                            ...
                            let input_idx_signed = (cur_out_idx * stride) as isize + k as isize - padding as isize;
                            
                            if input_idx_signed >= 0 && input_idx_signed < in_length as isize {
                                loaded_inputs[lane] = *input.data.get_unchecked(in_start + input_idx_signed as usize);
                            } else {
            ...
            for i in o_idx..out_length {
                ...
                for ic in 0..in_channels {
                    ...
                    let in_start = input_offset_base + ic * in_length;
                     ...
                     for k in 0..kernel_size {
                        let input_idx_signed = (i * stride) as isize + k as isize - padding as isize;
                        if input_idx_signed >= 0 && input_idx_signed < in_length as isize {
                            let val = *input.data.get_unchecked(in_start + input_idx_signed as usize);
